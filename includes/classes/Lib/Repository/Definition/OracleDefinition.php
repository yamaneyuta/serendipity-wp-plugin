...
class OracleDefinition {
	...
	public function __construct() {
		$this->oracle_data = array(
			...
			array( ChainID::ETH_MAINNET, 'CAD', 'USD', '0xa34317DB73e77d453b1B8d04550c44D10e981C8e' ),
			array( ChainID::ETH_MAINNET, 'CHF', 'USD', '0x449d117117838fFA61263B61dA6301AA2a88B13A' ),
			...
			array( ChainID::ETH_MAINNET, 'NZD', 'USD', '0x3977CFc9e4f29C184D4675f4EB8e0013236e5f3e' ),

			array( ChainID::ETH_MAINNET, 'ETH', 'USD', '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419' ),
			array( ChainID::ETH_MAINNET, 'BAT', 'ETH', '0x0d16d4528239e9ee52fa531af613AcdB23D88c94' ),
			array( ChainID::ETH_MAINNET, 'LINK', 'USD', '0x2c1d072e956AFFC0D435Cb7AC38EF18d24d9127c' ),
			array( ChainID::ETH_MAINNET, 'USDC', 'USD', '0x8fFfFfd4AfB6115b954Bd326cbe7B4BA576818f6' ),
			// array( ChainID::ETH_MAINNET, 'USDC', 'USD', '0x8fFfFfd4AfB6115b954Bd326cbe7B4BA576818f6' ),
			// array( ChainID::ETH_MAINNET, 'USDT', 'USD', '0x3E7d1eAB13ad0104d2750B8863b489D65364e32D' ),

			array( ChainID::POLYGON_ZK_EVM, 'MATIC', 'USD', '0x7C85dD6eBc1d318E909F22d51e756Cf066643341' ),
